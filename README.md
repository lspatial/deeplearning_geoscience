...
$$
 ...
 $\lambda _{i} \le 1$; $i=1,2,\dots ,k$。<br>（3）将 $P$的分解结果代入 $\pi _{t+1}= \pi _{t}P^{t} =\pi _{t}(Q\Lambda Q^{-1})^{t}=\pi _{t}(Q\Lambda Q^{-1}Q\Lambda Q^{-1}\dots Q\Lambda Q^{-1})$，由于 $Q^{-1}Q=E$，即单位矩阵，因此
